...
dir_path = "C:\\Users\\nsdev\\code\\biology\\czifile_public_project\\data"
fn_mouse = os.path.join(
    dir_path, r"MouseBrain_41Slices_1Tile_3Channel_2Illuminations_2Angles.czi")
fn_stacks = os.path.join(dir_path, r"T=3_Z=5_CH=2_X=240_Y=170.czi")  # 5d-stack
fn_scenes = os.path.join(dir_path, r"w96_A1+A2.czi")  # scene file
...
def read_czi_file_json():
    ...
    for key, values in md_dict["ImageDocument"]["Metadata"].items():
        print(key)
    print(json.dumps(md_dict["ImageDocument"]["Metadata"]
          ["Information"]["Image"], sort_keys=False, indent=4))
